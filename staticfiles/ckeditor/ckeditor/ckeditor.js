...
(function () {
        ...
        on: function (b, d, g, k, l) {
          ...
          if (0 > e.getListenerIndex(d)) {
            ...
            for (var r = e.length - 1; 0 <= r; r--)
              if (e[r].priority <= l)
                return e.splice(r + 1, 0, m), { removeListener: u };
            e.unshift(m);
          }
  ...
  (function () {
    ...
    CKEDITOR.tools = {
      ...
      transformPlainTextToHtml: function (a, e) {
        ...
        b ||
          (c = c.replace(
            new RegExp("\x3cbr\x3e(?\x3d\x3c/" + l + "\x3e)"),
            function (a) {
      ...
      normalizeCssText: function (a, e) {
        var b = [],
          c,
          l = CKEDITOR.tools.parseCssText(a, !0, e);
      ...
      parseCssText: function (a, b, c) {
        ...
        a.replace(/&quot;/g, '"').replace(
          ...
          function (a, c, d) {
            b &&
              ((c = c.toLowerCase()),
              "font-family" == c && (d = d.replace(/\s*,\s*/g, ",")),
      ...
      getCookie: function (a) {
        ...
        for (var b = document.cookie.split(";"), c, l, d = 0; d < b.length; d++)
          if (
            ((c = b[d].split("\x3d")),
            (l = decodeURIComponent(CKEDITOR.tools.trim(c[0]).toLowerCase())),
            l === a)
          )
        ...
        if (!a || 40 != a.length) {
          ...
          for (c = 0; c < a.length; c++)
            var l = "abcdefghijklmnopqrstuvwxyz0123456789".charAt(a[c] % 36),
              b = b + (0.5 < Math.random() ? l.toUpperCase() : l);
          a = b;
  ...
  CKEDITOR.dtd = (function () {
    var a = CKEDITOR.tools.extend,
      d = function (a, b) {
        for (
          var c = CKEDITOR.tools.clone(a), l = 1;
          l < arguments.length;
          l++
        ) {
          b = arguments[l];
  ...
  CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
    ...
    getIndex: function (a) {
      function d(a, c) {
        ...
        return m && m.nodeType == CKEDITOR.NODE_TEXT
          ? b(m)
            ? d(m, c)
            : m
          : null;
      ...
      do
        (a && c != this.$ && c.nodeType == CKEDITOR.NODE_TEXT && (g || b(c))) ||
          (f++, (g = c.nodeType == CKEDITOR.NODE_TEXT));
  ...
  (function () {
    ...
    function c(a) {
      for (var b = 0, c = 0, e = k[a].length; c < e; c++)
        b += parseInt(this.getComputedStyle(k[a][c]) || 0, 10) || 0;
      return b;
    }
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
          ...
          if (c && c.type == CKEDITOR.NODE_ELEMENT) {
            for (
              ...
              if (
                ...
                return;
            if (b.isIdentical(c)) {
              for (var l = e ? b.getLast() : b.getFirst(); d.length; )
                d.shift().move(b, !e);
              c.moveChildren(b, !e);
              c.remove();
        ...
        if (
          ...
          k &&
            ...
            (CKEDITOR.env.ie && 12 <= CKEDITOR.env.version)
              ...
              : ((c = r ? d.$ : g), (b = c.scrollLeft), (c = c.scrollTop)),
            (b = f.left + b - w),
            (c = f.top + c - q));
        } else
          for (
            ...
            for (; w && !w.equals(q); )
              (b -= w.$.scrollLeft), (c -= w.$.scrollTop), (w = w.getParent());
            w = q;
      ...
      scrollIntoParent: function (a, b, c) {
        ...
        a instanceof CKEDITOR.dom.window &&
          (a = k ? r.getBody() : r.getDocumentElement());
        CKEDITOR.env.webkit &&
          (r = this.getEditor(!1)) &&
          (r._.previousScrollTop = null);
        r = a.getWindow();
        d = q(this, r);
        var t = q(a, r),
          v = this.$.offsetHeight;
      ...
      copyAttributes: function (a, b) {
        ...
        for (var e = 0; e < c.length; e++) {
          var d = c[e],
            ...
            g;
          if (!(f in b))
            if ("checked" == f && (g = this.getAttribute(f)))
              a.setAttribute(f, g);
            else if (!CKEDITOR.env.ie || this.hasAttribute(f))
              (g = this.getAttribute(f)),
            ...
            ? e.type == CKEDITOR.NODE_ELEMENT &&
              (e =
                0 < A
                  ...
                  : !1 === v(e, !0)
                  ? null
                  : e.getPreviousSourceNode(!0, p, v))
            : ((e = d),
              e.type == CKEDITOR.NODE_ELEMENT &&
                ((e = e.getChild(f)) ||
                  (e =
                    !1 === v(d, !0) ? null : d.getNextSourceNode(!0, p, v)))),
          e && !1 === v(e) && (e = null));
      for (; e && !this._.end; ) {
        this.current = e;
          ...
          : b.type == CKEDITOR.NODE_TEXT ||
            (b.type == CKEDITOR.NODE_ELEMENT &&
              (b.is(CKEDITOR.dtd.$inline) ||
                ...
                (!CKEDITOR.env.needsBrFiller && b.is(A) && e(b))))
          ? !0
          : !1;
        return !!(a ^ b);
      };
  ...
  (function () {
    ...
    function d(a, b, c, d, f) {
      ...
      function k() {
        ...
        b < F - 1 || b < K - 1 || c
          ? (c
              ...
              : K == b + 1 && E
              ? a.moveToPosition(B[b], CKEDITOR.POSITION_BEFORE_END)
              : a.moveToPosition(B[b + 1], CKEDITOR.POSITION_BEFORE_START),
            d &&
              (b = N[b + 1]) &&
              b.type == CKEDITOR.NODE_ELEMENT &&
      ...
      var p = a.startContainer,
        ...
        m,
        O;
      if (h && n.type == CKEDITOR.NODE_TEXT && p.equals(n))
        (p = a.document.createText(p.substring(y, z))), c.append(p);
      else {
        ...
        for (
          ...
          U = Z.getNext();
          for (
            Q != F || (Z.equals(B[Q]) && F < K)
              ? b && (L = G.append(Z.clone(0, f)))
              : J
              ? q(Z, G, !1, C)
              : m && G.append(a.document.createText(Z.substring(y)));
            U;
        ...
        G = c;
        for (Q = I; Q <= K; Q++)
          if (((c = B[Q]), (U = c.getPrevious()), c.equals(N[Q])))
            b && (G = G.getChild(0));
          else {
            Q != K || (c.equals(N[Q]) && K < F)
              ? b && (L = G.append(c.clone(0, f)))
              : E
              ? q(c, G, !1, u)
              : O && G.append(a.document.createText(c.substring(0, z)));
      ...
      return function (f) {
        return c(f) || b(f)
          ...
          : (f.type == CKEDITOR.NODE_TEXT &&
            ...
            (f.type == CKEDITOR.NODE_ELEMENT && !f.is(g))
          ? !1
          : !0;
      };
    }
    ...
    CKEDITOR.dom.range.prototype = {
      ...
      createBookmark2: (function () {
        function a(b) {
          ...
          var g = d;
          f =
            f.type != CKEDITOR.NODE_ELEMENT || 0 === g || g == f.getChildCount()
              ? 0
              : f.getChild(g - 1).type == CKEDITOR.NODE_TEXT &&
                f.getChild(g).type == CKEDITOR.NODE_TEXT;
          ...
          if (e.type == CKEDITOR.NODE_TEXT) {
            ...
            e.getText()
              ...
              : ((g = e.getPrevious(c)),
                f
                  ? ((d = f), (e = g ? g.getNext() : e.getParent().getFirst()))
                  : ((e = e.getParent()), (d = g ? g.getIndex(!0) + 1 : 0)));
          }
          b.container = e;
          b.offset = d;
        }
        ...
        switch (a) {
          ...
          case CKEDITOR.ENLARGE_ELEMENT:
            ...
            z.type == CKEDITOR.NODE_TEXT
              ? (E &&
                  ((z = !CKEDITOR.tools.trim(z.substring(0, E)).length && z),
                  (y = !!z)),
                z && ((p = z.getPrevious()) || (h = z.getParent())))
              : (E && (p = z.getChild(E - 1) || z.getLast()), p || (h = z));
            for (h = c(h); h || p; ) {
              if (h && !p) {
                !n && h.equals(g) && (n = !0);
                if (f ? h.isBlockBoundary() : !k.contains(h)) break;
                (y && "inline" == h.getComputedStyle("display")) ||
                  ((y = !1), n ? (l = h) : this.setStartBefore(h));
                p = h.getPrevious();
              }
              for (; p; )
                if (((z = !1), p.type == CKEDITOR.NODE_COMMENT))
                  p = p.getPrevious();
                else {
                  if (p.type == CKEDITOR.NODE_TEXT)
                    ...
                    if (y && CKEDITOR.dtd.$removeEmpty[p.getName()]) {
                      ...
                      if (d.test(J)) p = null;
                        ...
                        for (
                          var E = p.$.getElementsByTagName("*"), C = 0, u;
                          (u = E[C++]);

                        )
                          if (
                            !CKEDITOR.dtd.$removeEmpty[u.nodeName.toLowerCase()]
                          ) {
                            p = null;
                            break;
                          }
            ...
            n = y = !1;
            z.type == CKEDITOR.NODE_TEXT
              ? CKEDITOR.tools.trim(z.substring(E)).length
                ? (y = !0)
                : ((y = !z.getLength()),
                  E == z.getLength()
                    ? (p = z.getNext()) || (h = z.getParent())
                    : q(z, E) && (h = z.getParent()))
              : (p = z.getChild(E)) || (h = z);
            for (; h || p; ) {
              if (h && !p) {
                ...
                if (f ? h.isBlockBoundary() : !k.contains(h)) break;
                (y && "inline" == h.getComputedStyle("display")) ||
                  ((y = !1), n ? (v = h) : h && this.setEndAfter(h));
                p = h.getNext();
              }
              for (; p; ) {
                z = !1;
      ...
      shrink: function (a, b, c) {
        if (!this.collapsed) {
          ...
          l &&
            (f = d[a == CKEDITOR.SHRINK_ELEMENT ? "lastForward" : "next"]()) &&
            this.setStartAt(
              f,
    ...
    a.prototype = {
      getNextParagraph: function (a) {
        ...
        if (!this._.started) {
          ...
          q.collapsed ||
            ((k = new CKEDITOR.dom.walker(q.clone())),
            (w = CKEDITOR.dom.walker.bookmark(!0, !0)),
            (k.evaluator = w),
            (this._.nextNode = k.next()),
            (k = new CKEDITOR.dom.walker(q.clone())),
            (k.evaluator = w),
            (k = k.previous()),
            (this._.lastNode = k.getNextSourceNode(!0, null, q.root)),
            this._.lastNode &&
              ...
              ((w = this.range.clone()),
              w.moveToPosition(this._.lastNode, CKEDITOR.POSITION_AFTER_END),
              w.checkEndOfBlock() &&
                ((w = new CKEDITOR.dom.elementPath(w.endContainer, w.root)),
                (this._.lastNode = (w.block || w.blockLimit).getNextSourceNode(
                  !0
                )))),
            (this._.lastNode && q.root.contains(this._.lastNode)) ||
              ((this._.lastNode = this._.docEndMarker =
                q.document.createText("")),
        ...
        for (this._.nextNode = null; w; ) {
          ...
          if (v) w.type == CKEDITOR.NODE_TEXT && f.test(w.getText()) && (v = 0);
            ...
            if (
              ...
              "false" == w.getAttribute("contenteditable")
            ) {
              d = w;
              b(this, a, d);
              break;
            } else if (
              w.isBlockBoundary(this.forceBrBreak && !t && { br: 1 })
            ) {
              if ("br" == p) v = 1;
              ...
              k &&
                (k.setEndAt(w, CKEDITOR.POSITION_BEFORE_START),
                "br" != p && (this._.nextNode = w));
              H = 1;
            } else {
              if (w.getFirst()) {
                k ||
                  ((k = this.range.clone()),
                  k.setStartAt(w, CKEDITOR.POSITION_BEFORE_START));
                w = w.getFirst();
                continue;
              }
              v = 1;
          ...
          !w.equals(k.root)
            ...
            : r ||
              (this._.nextNode = d.equals(q)
                ? null
                : this._getNextSourceNode(k.getBoundaryNodes().endNode, 1, q));
        }
        x &&
          (x = d.getPrevious()) &&
        ...
        D &&
          ...
          x.type == CKEDITOR.NODE_ELEMENT &&
          "br" == x.getName() &&
          (!CKEDITOR.env.needsBrFiller || x.getPrevious(g) || x.getNext(g)) &&
          x.remove();
        this._.nextNode ||
          (this._.nextNode =
            r || d.equals(q) || !q ? null : this._getNextSourceNode(d, 1, q));
        return d;
      },
  ...
  (function () {
    function a(a, b, c, d, f) {
      ...
      for (h in b) {
        ...
        for (F in O) {
          ...
          for (K in y)
            "!" == K.charAt(0) &&
              ((K = K.slice(1)), B.push(K), (v[K] = !0), (z = !1));
          ...
          if (
            ...
            if (a)
              if (!0 === a) a = !0;
                ...
                for (var p = 0, f = c.length, n; p < f; ++p)
                  (n = c[p]), h[n] || (h[n] = a(n));
                a = !1;
              }
            else a = !1;
      ...
      if ((h = a.requiredClasses))
        for (p = b.classes, c = 0; c < h.length; ++c)
          if (((d = h[c]), "string" == typeof d)) {
            ...
            return !1;
      return (
        m(b.styles, a.requiredStyles) && m(b.attributes, a.requiredAttributes)
      );
    }
    function m(a, b) {
      if (!b) return !0;
    ...
    function e(a) {
      var b,
        ...
        p = {},
        f = 1;
      for (a = Y(a); (b = a.match(B)); )
        (c = b[2])
          ? ((d = A(c, "styles")), (h = A(c, "attrs")), (c = A(c, "classes")))
          : (d = h = c = null),
          (p["$" + f++] = {
            elements: b[1],
            classes: c,
    ...
    function v(a) {
      return (
        a.type == CKEDITOR.NODE_ELEMENT && ("br" == a.name || E.$block[a.name])
      );
    }
    function h(a, b, c) {
      var d = a.name;
      if (E.$empty[d] || !a.children.length)
        "hr" == d && "br" == b
          ? a.replaceWith(t())
          : (a.parent && c.push({ check: "it", el: a.parent }), a.remove());
      else if (E.$block[d] || "tr" == d)
        if ("br" == b)
          a.previous && !v(a.previous) && ((b = t()), b.insertBefore(a)),
            a.next && !v(a.next) && ((b = t()), b.insertAfter(a)),
          ...
          if (h)
            ...
            for (
              ...
              (n = d[--f]),
                p &&
                (n.type == CKEDITOR.NODE_TEXT ||
                  (n.type == CKEDITOR.NODE_ELEMENT && E.$inline[n.name]))
                  ? (e ||
                      ((e = new CKEDITOR.htmlParser.element(b)),
                      e.insertAfter(a),
                      c.push({ check: "parent-down", el: e })),
                    e.add(n, 0))
                  : ((e = null),
                    (g = E[h.name] || E.span),
                    n.insertAfter(a),
    ...
    function n(a, b) {
      ...
      for (p in d)
        if ("class" == p)
          for (
            c = d[p].split(/\s+/), n = a.classes.join("|");
            (e = c.pop());
      ...
      if (a instanceof CKEDITOR.editor) {
        ...
        !0 === b
          ...
          : (b || (this.customConfig = !1),
            ...
            this.allow(
              P[a.enterMode] + " " + P[a.shiftEnterMode],
              "default",
              1
            ),
    ...
    CKEDITOR.filter.prototype = {
      ...
      applyTo: function (a, b, c, d) {
        ...
        for (; (v = a.pop()); )
          if (((c = v.el), c.parent))
            switch (((y = E[c.parent.name] || E.span), v.check)) {
              case "it":
                E.$removeEmpty[c.name] && !c.children.length
                  ? h(c, d, a)
                  : w(c) || h(c, d, a);
                break;
              case "el-up":
      ...
      check: function (a, b, c) {
        ...
        if ("string" == typeof a) {
          ...
          (d = a.getDefinition()),
            (h = d.styles),
            (n = d.attributes || {}),
            h && !CKEDITOR.tools.isEmpty(h)
              ? ((h = C(h)), (n.style = CKEDITOR.tools.writeCssText(h, !0)))
              : (h = {}),
            (h = {
              name: d.element,
              attributes: n,
        ...
        b =
          0 < g.length
            ? !1
            : CKEDITOR.tools.objectCompare(h.attributes, n.attributes, !0)
            ? !0
            : !1;
      ...
      transform: function (a, b) {
        if ("string" == typeof b) a.name = b;
          ...
          for (p in h)
            if ("class" == p)
              for (
                c = a.classes.join("|"), f = h[p].split(/\s+/);
                (e = f.pop());

              )
                -1 == c.indexOf(e) && a.classes.push(e);
  ...
  CKEDITOR.resourceManager.prototype = {
    ...
    load: function (a, d, b) {
      ...
      for (
        var c = this.loaded, f = this.registered, g = [], k = {}, l = {}, m = 0;
        m < a.length;
        m++
      ) {
        var u = a[m];
            ...
            a.call(
              ...
              function (a) {
                ...
                for (e in a) {
                  ...
                  if (!d[e]) {
                    if (l.icons)
                      for (var x = l.icons.split(","), D = x.length; D--; )
                        CKEDITOR.skin.addIcon(
                          x[D],
                          l.path +
                            "icons/" +
                            (CKEDITOR.env.hidpi && l.hidpi ? "hidpi/" : "") +
                            x[D] +
                            ".png"
                        );
                    d[e] = 1;
  ...
  (function () {
      ...
      CKEDITOR.plugins.load(c.split(","), function (c) {
        ...
        for (var e in c) {
          ...
          v &&
            !a.lang[e] &&
            (v.split && (v = v.split(",")),
            0 <= CKEDITOR.tools.indexOf(v, a.langCode)
              ? (k = a.langCode)
              : ((k = a.langCode.replace(/-.*/, "")),
                (k =
                  k != a.langCode && 0 <= CKEDITOR.tools.indexOf(v, k)
                    ? k
                    : 0 <= CKEDITOR.tools.indexOf(v, "en")
                    ? "en"
                    : v[0])),
            g.langEntries && g.langEntries[k]
              ? ((a.lang[e] = g.langEntries[k]), (k = null))
          ...
          for (
            ...
            for (var p = 0; p < d.length; p++) {
              ...
              0 === f &&
                ...
                n.lang &&
                n.langEntries &&
                (a.lang[n.name] = n.langEntries[h[p]]);
              if (n[c[f]]) n[c[f]](a);
            }
    ...
    CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
      ...
      getSelectedHtml: function (a) {
        ...
        for (
          var d = new CKEDITOR.dom.documentFragment(), f, h, p, n = 0;
          n < c.length;
          n++
        ) {
          var e = c[n],
          ...
          g.getName && "tr" == g.getName()
            ? (f ||
                ((f = g.getAscendant("table").clone()),
                f.append(g.getAscendant("tbody").clone()),
                d.append(f),
                (f = f.findOne("tbody"))),
              (h && h.equals(g)) || ((h = g), (p = g.clone()), f.append(p)),
              p.append(e.cloneContents()))
            : d.append(e.cloneContents());
        }
  ...
  (function () {
    ...
    CKEDITOR.htmlParser.fragment.fromHtml = function (g, k, l) {
      function m(a) {
        ...
        if (0 < w.length)
          for (var c = 0; c < w.length; c++) {
            ...
            (e && !e[h]) || (a && f && !f[a] && CKEDITOR.dtd[a])
              ? h == t.name && (A(t, t.parent, 1), c--)
              : (b || (u(), (b = 1)),
                (d = d.clone()),
                (d.parent = t),
                (t = d),
      ...
      function A(b, c, d) {
        ...
        var f = t;
        void 0 === b.previous &&
          (r(c, b) && ((t = c), D.onTagOpen(l, {}), (b.returnPoint = c = t)),
          e(b),
          ...
          if ("br" == f) H.push(n);
            ...
            for (
              ...
              !((g = (e = t.name)
                ...
                : c),
              n.isUnknown || t.isUnknown || g[f]);

            )
              if (t.isOptionalClose) D.onTagClose(e);
              else if (f in b && e in b)
                (e = t.children),
                  ((e = e[e.length - 1]) && "li" == e.name) ||
                    A((e = new CKEDITOR.htmlParser.element("li")), t),
                  !n.returnPoint && (n.returnPoint = t),
                  (t = e);
              else if (f in CKEDITOR.dtd.$listItem && !x(f, e))
                D.onTagOpen("li" == f ? "ul" : "dl", {}, 0, 1);
              else if (e in d && !x(f, e))
                !n.returnPoint && (n.returnPoint = t), (t = t.parent);
              else if ((e in CKEDITOR.dtd.$inline && w.unshift(t), t.parent))
                A(t, t.parent, 1);
              else {
                n.isOrphan = 1;
                break;
      ...
      D.onText = function (a) {
        if (
          !((t._.hasInlineStarted && !H.length) || h || v) &&
  ...
  (function () {
    ...
    a.prototype = {
      ...
      addMany: function (a, c, d) {
        for (var g = [this.findIndex(c), 0], k = 0, l = a.length; k < l; k++)
      ...
      execOnName: function (a, c) {
        for (var d = 0, g = this.rules, k = g.length, l; c && d < k; d++)
          (l = g[d]),
        ...
        return function (h) {
          if (h.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
            var f = [],
              ...
              F;
            if (n)
              for (p(n, 1) && f.push(n); n; )
                g(n) &&
                  (v = c(n)) &&
                  p(v) &&
                  ((F = c(v)) && !g(F)
                    ? f.push(v)
                    : (e(y).insertAfter(v), v.remove())),
                  (n = n.previous);
            for (n = 0; n < f.length; n++) f[n].remove();
            if ((f = !a || !1 !== ("function" == typeof d ? d(h) : d)))
              y ||
              CKEDITOR.env.needsBrFiller ||
              h.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT
                ? y ||
    ...
    function e(a, b) {
      return a.replace(b, function (a, b, c) {
        0 === a.indexOf("\x3ctextarea") &&
          (a =
            b +
            x(c).replace(/</g, "\x26lt;").replace(/>/g, "\x26gt;") +
            "\x3c/textarea\x3e");
        return (
      ...
      b.on(
        ...
        function (a) {
          ...
          CKEDITOR.env.ie &&
            9 > CKEDITOR.env.version &&
            "pre" == h &&
            ((h = "div"), (c = "\x3cpre\x3e" + c + "\x3c/pre\x3e"), (f = 1));
          ...
          h &&
            ((f = c),
            !f.children.length &&
              CKEDITOR.dtd[f.name][h] &&
              ((h = new CKEDITOR.htmlParser.element(h)), f.add(h)));
          a.dataValue = c;
        },
        null,
        null,
  ...
  (function () {
    ...
    CKEDITOR.inlineAll = function () {
      ...
      for (b in CKEDITOR.dtd.$editable)
        for (
          var c = CKEDITOR.document.getElementsByTag(b), f = 0, g = c.count();
          f < g;
          f++
        )
          (a = c.getItem(f)),
  ...
  (function () {
          ...
          if (!this.is("textarea")) {
            ...
            this.attachListener(a, "key", function (b) {
              ...
              if (c in l) {
                ...
                (h = g(b))
                  ? (a.fire("saveSnapshot"),
                    f.moveToPosition(h, CKEDITOR.POSITION_BEFORE_START),
                    h.remove(),
                    f.select(),
                    a.fire("saveSnapshot"),
                    (d = 1))
                    ...
                    f[c ? "checkStartOfBlock" : "checkEndOfBlock"]()
                      ? (a.fire("saveSnapshot"),
                        f[c ? "checkEndOfBlock" : "checkStartOfBlock"]() &&
                          p.remove(),
                        f["moveToElementEdit" + (c ? "End" : "Start")](y),
                        f.select(),
                        a.fire("saveSnapshot"),
                        (d = 1))
                      : n.blockLimit &&
                        n.blockLimit.is("td") &&
                        (k = n.blockLimit.getAscendant("table")) &&
                        f.checkBoundaryOfElement(
                          k,
                          c ? CKEDITOR.START : CKEDITOR.END
                        ) &&
                        (y = k[c ? "getPrevious" : "getNext"](e))
                      ? (a.fire("saveSnapshot"),
                        f["moveToElementEdit" + (c ? "End" : "Start")](y),
    ...
    q = (function () {
                ...
                u && n in CKEDITOR.dtd.$list
                  ...
                  : ((p = !!k[n]),
                    "br" != n ||
                      ...
                      (y && y != z - 1) ||
                      ((q =
                        (e = y ? g[y - 1].node : l.getItem(y + 1)) &&
                        (!a(e) || !e.is("br"))),
                      (e = e && a(e) && E.$block[e.getName()])),
                    -1 != J || p || (J = y),
                    p || (m = y),
                    g.push({
                      isElement: 1,
                    ...
                    (e = q = 0)))
              : g.push({ isElement: 0, node: f, allowed: 1 });
      ...
      function d(b, c) {
        ...
        for (y && f.push(" "); g < h; g++)
          (n = e.getItem(g)),
            a(n) && !n.is(k) ? (f = f.concat(d(n, c))) : f.push(n);
        y && f.push(" ");
        return f;
      }
      function f(b) {
      ...
      function e(b) {
        return (
          b &&
          a(b) &&
          (b.is(E.$removeEmpty) || (b.is("a") && !b.isBlockBoundary()))
        );
      }
      function g(b, c, d, f) {
        var e = b.clone(),
        ...
        (h = new CKEDITOR.dom.walker(e).next()) &&
          ...
          f.contains(h) &&
          h.isIdentical(n) &&
          (h.moveChildren(n), h.remove(), g(b, c, d, f));
      }
      function J(b, c) {
        function d(b, c) {
          if (
      ...
      return function (m, C, B, I) {
        ...
        if (!I.checkReadOnly()) {
          var G =
            new CKEDITOR.dom.elementPath(I.startContainer, I.root).blockLimit ||
            I.root;
          m = {
            type: C,
            dontFilter: K,
          ...
          var L, r;
          "text" == m.type &&
            C.shrink(CKEDITOR.SHRINK_ELEMENT, !0, !1) &&
            ((L = CKEDITOR.dom.element.createFromHtml(
              "\x3cspan\x3e\x26nbsp;\x3c/span\x3e",
              C.document
            )),
            C.insertNode(L),
          ...
          for (; (r = f(C)) && a(r) && r.isBlockBoundary() && K.contains(r); )
            C.moveToPosition(r, CKEDITOR.POSITION_BEFORE_END);
          g(C, m.blockLimit, K, G);
          L && (C.setEndBefore(L), C.collapse(), L.remove());
          L = C.startPath();
          if ((F = L.contains(e, !1, 1)))
            C.splitElement(F),
              (m.inlineStylesRoot = F),
              (m.inlineStylesPeak = L.lastElement);
          L = C.createBookmark();
          (F = L.startNode.getPrevious(c)) && a(F) && e(F) && I.push(F);
          (F = L.startNode.getNext(c)) && a(F) && e(F) && I.push(F);
          for (F = L.startNode; (F = F.getParent()) && e(F); ) I.push(F);
          C.moveToBookmark(L);
          if ((L = B)) {
            L = m.range;
            if ("text" == m.type && m.inlineStylesRoot) {
              ...
              for (I = m.inlineStylesRoot.getParent(); !r.equals(I); )
                (C = C.appendTo(r.clone())), (r = r.getParent());
          ...
          if (L) {
            ...
            for (J(C, x); I < C.length; I++) {
              ...
              if ((t = G.isLineBreak)) {
                ...
                G.hasBlockSibling
                  ? (t = 1)
                  : (T = t.startContainer.getAscendant(E.$block, 1)) &&
                    T.is({ div: 1, p: 1 })
                  ? ((aa = T.getPosition(R)),
                    ...
                    aa == CKEDITOR.POSITION_CONTAINS
                      ? (t = 0)
                      : ((R = t.splitElement(T)),
                        t.moveToPosition(R, CKEDITOR.POSITION_AFTER_START),
                        (t = 1)))
                  : (t = 0);
              }
              if (t) B = 0 < I;
                ...
                t = x.startPath();
                !G.isBlock &&
                  k(m.editor, t.block, t.blockLimit) &&
                  (H = l(m.editor)) &&
                  ((H = L.createElement(H)),
                  H.appendBogus(),
                  x.insertNode(H),
                  CKEDITOR.env.needsBrFiller &&
                    (D = H.getBogus()) &&
                    D.remove(),
                  x.moveToPosition(H, CKEDITOR.POSITION_BEFORE_END));
            ...
            1 != C.length
              ...
              : ((D = C[0]),
                (D =
                  D.isElement &&
                  "false" == D.node.getAttribute("contenteditable")));
            D &&
              ((B = !0),
              (t = C[0].node),
          ...
          for (X = D.createBookmark(); (M = m.zombies.pop()); )
            M.getParent() &&
              ((H = D.clone()),
          ...
          if (W)
            for (; (M = W.pop()); )
              CKEDITOR.env.needsBrFiller
                ? M.appendBogus()
                : M.append(D.document.createText(" "));
      ...
      return function (d) {
        ...
        e.is("table")
          ? (d.setStartAt(e, CKEDITOR.POSITION_BEFORE_START),
            d.collapse(!0),
            e.remove())
          : (e.is({ tbody: 1, thead: 1, tfoot: 1 }) && (e = b(e, "tr", g)),
            e.is("tr") &&
              (e = b(e, e.getParent().is("thead") ? "th" : "td", g)),
      ...
      return {
        list: {
          detectMerge: function (a, b) {
            ...
            a.mergeList =
              h && g && h.getParent().equals(g.getParent()) && !h.equals(g);
            a.mergeListItems =
              e.block &&
              f.block &&
              e.block.is(CKEDITOR.dtd.$listItem) &&
              ...
              if (m || l)
                m && l && b(m, l)
                  ? ((e.tableSurroundingRange = g),
                    g.setStartAt(m, CKEDITOR.POSITION_AFTER_END),
                    g.setEndAt(l, CKEDITOR.POSITION_BEFORE_START),
                    (g = h.clone()),
                    g.setEndAt(m, CKEDITOR.POSITION_AFTER_END),
                    (k = h.clone()),
      ...
      for (var b = 0; b < a.length; b++) {
        ...
        if (!c.collapsed) {
          ...
          d &&
            ...
            (f >= d.getLength() ? k.setStartAfter(d) : k.setStartBefore(d));
          e &&
            e.type == CKEDITOR.NODE_TEXT &&
            (g ? k.setEndAfter(e) : k.setEndBefore(e));
              ...
              l.on("mousedown", function (a) {
                function b(a) {
                  ...
                  if (F) {
                    ...
                    F.setEndPoint(
                      0 > K.compareEndPoints("StartToStart", c)
                        ? "EndToEnd"
                        : "StartToStart",
                      c
                    );
        ...
        : function () {
            ...
            if (!c || !c.rangeCount) b = CKEDITOR.SELECTION_NONE;
              ...
              d == c.endContainer &&
                ...
                v[d.childNodes[c.startOffset].nodeName.toLowerCase()] &&
              ...
              var b = function (b, c) {
                ...
                if (-1 == B || (B == e.length - 1 && 0 > n)) {
                  ...
                  for (d = e.length; 0 < g && 0 < d; )
                    (h = e[--d]),
                      h.nodeType == CKEDITOR.NODE_TEXT &&
                        ((m = h), (g -= h.nodeValue.length));
                ...
                for (; 0 < g; )
                  try {
                    (h = f[0 < n ? "previousSibling" : "nextSibling"]),
                      h.nodeType == CKEDITOR.NODE_TEXT &&
                        ((g -= h.nodeValue.length), (m = h)),
                      (f = h);
                  } catch (K) {
          ...
          if (this.isLocked) {
            ...
            if (l) this.fake(l);
              ...
              if (A) {
                ...
                1 < a.length &&
                  ((l = a[a.length - 1]),
                  a[0].setEnd(l.endContainer, l.endOffset));
                l = a[0];
                a = l.collapsed;
                var u, r, t;
                if (
                ...
                if (
                  (l.startContainer.type == CKEDITOR.NODE_ELEMENT &&
                    l.startContainer.getName() in b) ||
                  (l.endContainer.type == CKEDITOR.NODE_ELEMENT &&
                    l.endContainer.getName() in b)
                )
                  l.shrink(CKEDITOR.NODE_ELEMENT, !0), (a = l.collapsed);
                t = l.createBookmark();
                b = t.startNode;
                a || (e = t.endNode);
                ...
                e
                  ? ((m = l.document.$.body.createTextRange()),
                    ...
                    t.setEndPoint("EndToEnd", m),
                    t.moveEnd("character", -1))
                  : ((u = b.getNext(q)),
                    (r = b.hasAscendant("pre")),
                    (u =
                      !(u && u.getText && u.getText().match(m)) &&
                      (r ||
                        !b.hasPrevious() ||
                    ...
                    r.setHtml("\x26#65279;"),
                    r.insertBefore(b),
                    u && l.document.createText("﻿").insertBefore(b));
                l.setStartBefore(b);
                b.remove();
                a
                  ? (u
                      ? (t.moveStart("character", -1),
                        t.select(),
                        l.document.$.selection.clear())
                      : t.select(),
                    l.moveToPosition(r, CKEDITOR.POSITION_BEFORE_START),
                    r.remove())
                  : (l.setEndBefore(e), e.remove(), t.select());
              } else {
                e = this.getNative();
                if (!e) return;
                ...
                for (t = 0; t < a.length; t++) {
                  ...
                  l.collapsed &&
                    ...
                    "br" == u.getName()
                      ? (k(this.root),
                        l.moveToPosition(u, CKEDITOR.POSITION_BEFORE_START))
                      : l.moveToPosition(m, CKEDITOR.POSITION_AFTER_END));
                  r.setStart(l.startContainer.$, l.startOffset);
                  try {
                    r.setEnd(l.endContainer.$, l.endOffset);
                  } catch (B) {
                    if (0 <= B.toString().indexOf("NS_ERROR_ILLEGAL_VALUE"))
                      l.collapse(1), r.setEnd(l.endContainer.$, l.endOffset);
                    else throw B;
                  }
                  e.addRange(r);
                }
          ...
          if (r.equals(u)) (r = null), (l = !0);
            ...
            if (v && m && CKEDITOR.dtd.$block[x])
              for (
                var w = r,
                  ...
                  C = y.length,
                  E = 0,
                  w = C && new CKEDITOR.dom.range(w.getDocument());
                E < C;
                ++E
              ) {
                var z = y[E],
                ...
                if (J ? J.check(this) : 1)
                  w.selectNodeContents(z), b.call(this, w);
              }
            ...
            if (y)
              if (
                ...
                (E = k),
                !z ||
                  (!(z.getDtd() || CKEDITOR.dtd.span)[C] && !E) ||
                  (y.parentRule && !y.parentRule(z)))
              )
                l = !0;
              else {
                if (
                  (t ||
                    (x &&
                      ...
                      (r.getPosition(u) | O) != O) ||
                    ((t = c.clone()), t.setStartBefore(r)),
                  (x = r.type),
                  x == CKEDITOR.NODE_TEXT ||
                    v ||
                    (x == CKEDITOR.NODE_ELEMENT && !r.getChildCount()))
                ) {
                  for (
                    var x = r, P;
                    (l = !x.getNext(Y)) &&
                    ((P = x.getParent()), n[P.getName()]) &&
                    d(P, q, h, N);
    ...
    CKEDITOR.style.prototype = {
      apply: function (a) {
        if (a instanceof CKEDITOR.dom.document)
          return y.call(this, a.getSelection());
      ...
      remove: function (a) {
        if (a instanceof CKEDITOR.dom.document)
          return y.call(this, a.getSelection(), 1);
        if (this.checkApplicable(a.elementPath(), a)) {
          var b = this._.enterMode;
          b || (this._.enterMode = a.activeEnterMode);
  ...
  CKEDITOR.tools.extend(CKEDITOR.dom.text.prototype, {
    ...
    split: function (a) {
      ...
      d.childNodes.length == b &&
        (a >= c
          ? ((g = f.createText("")), g.insertAfter(this))
          : ((a = f.createText("")), a.insertAfter(g), a.remove()));
      return g;
    },
        ...
        return {
          getNextRange: function (k) {
            ...
            if (l && 1 < a.length) {
              ...
              for (l.moveToBookmark(d.shift()); u--; )
                (m = a[++g]),
                  m.moveToBookmark(d.shift()),
                  l.setEnd(m.endContainer, m.endOffset);
            }
            return l;
          },
        };
          ...
          b.addRules(
            {
              elements: {
                "cke:object": function (b) {
                  var c = b.attributes;
                  if (
                    !((c.classid && String(c.classid).toLowerCase()) || d(b))
                  ) {
        ...
        a.ui.add("Language", CKEDITOR.UI_MENUBUTTON, {
          ...
          onMenu: function () {
            ...
            b.language_remove = d
              ...
              : CKEDITOR.TRISTATE_DISABLED;
            d &&
              (b["language_" + d.getAttribute("lang")] = CKEDITOR.TRISTATE_ON);
            return b;
          },
        });
      },
